...
class Data_dairas extends CI_Controller
{    
    ...
    {
            $this->load->view('admin/index_daira'); 
  ...
  // DataTable data
    ...
    ## Fetch records
    $empQuery = "select * from dairas WHERE 1 ".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$start.",".$rowperpage;
