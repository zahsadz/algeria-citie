 <div class="container-fluid">
  ...
  <h1 class="display-4 mt-5 mb-5 pr-5">تعديل دائرة  : <?php echo $city['name_ar']; ?> </h1>
 <?php
...
<div class="card bg-info">
  <div class="card-body text-right">
    ...
    <form action="<?= base_url('admin/update_daira/') ?><?php echo $city['id']; ?>" method="POST">
...
<label class="label"> الإسم باللغة الأجنبية</label>
       <input id="name_en" name="name_en" class="form-control" type="text" value="<?php echo html_entity_decode(stripslashes($city['name_en']), ENT_QUOTES, 'UTF-8' ); ?>">
        </div>
...
<label class="label"> خط الطول </label>
	...
	<?php foreach ($wilaya_id_name as $read) { ?>
