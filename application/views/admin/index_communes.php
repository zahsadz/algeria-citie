                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">تعديل بلدية</h4>
                        ...
                        <div class="modal-body">
                         ...
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="daira_id" >الدائرة </label>
                              <select id="daira_id" class="form-control">
                               <option value=""> -- select daira_id -- </option>
                                     </select>             
                            </div>   
...
var userDataTable =  $('#userTable').DataTable({
            ...
            serverSide: true,
            serverMethod: 'post',
            ajax: '<?php echo base_url(); ?>Data_communes/getTable',
            columns: [{
                    "data": "id"
                },
                {
...
// AJAX request
$.ajax({
url: '<?php echo base_url(); ?>Data_communes/Fetch',
type: 'post',
data: {id: id},
dataType: 'json',
...
$('#daira_id').val(response.data.daira_id);
...
var daira_id = $('#daira_id').val().trim();          
if(name_ar !='' && name_en != '' && daira_id != ''){
// AJAX request
$.ajax({
url: '<?php echo base_url(); ?>Data_communes/Update',
type: 'post',
data: {id: id, daira_id: daira_id,name_ar: name_ar, name_en: name_en, latitude: latitude,longitude: longitude},
dataType: 'json',
success: function(response){
if(response.status == 1){
alert(response.message);
// Empty the fields
// $('#name_ar','#name_en','#daira_id').val('');
// Reload DataTable
...
$.ajax({
url:'<?php echo base_url();?>Data_communes/deletes',
type:'post',
data:{ id : id },
dataType: 'html',
success: function(response){
...
// load daira_id
ajax('<?php echo base_url();?>Data_communes/Fetch_dairas', (res) => {
$('#daira_id').html('<option value="">-- select state --</option>');
for(let i = 0; i < res.length; i++)
$('#daira_id').append('<option value="'+ res[i].id +'">' + res[i].name_ar + '</option>');
});
</script>