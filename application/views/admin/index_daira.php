...
var userDataTable =  $('#userTable').DataTable({
            ...
            serverSide: true,
            serverMethod: 'post',
            ajax: '<?php echo base_url(); ?>Data_dairas/getTable',
            columns: [{
                    "data": "id"
                },
                {
...
// AJAX request
$.ajax({
url: '<?php echo base_url(); ?>Data_dairas/Fetch',
type: 'post',
data: {id: id},
dataType: 'json',
...
// AJAX request
$.ajax({
url: '<?php echo base_url(); ?>Data_dairas/Update',
type: 'post',
...
$.ajax({
url:'<?php echo base_url();?>Data_dairas/deletes',
type:'post',
data:{ id : id },
dataType: 'html',
success: function(response){
...
// load wilayas
ajax('<?php echo base_url();?>Data_dairas/Fetch_wilayas', (res) => {
